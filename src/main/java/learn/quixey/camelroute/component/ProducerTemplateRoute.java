...
public class ProducerTemplateRoute extends RouteBuilder {
    ...
    public static void main(String[] args) throws Exception {
        ...
        main.addRouteBuilder(new ProducerTemplateRoute());
        main.start();
        main.getCamelTemplate().asyncSend("direct:sedainvoker", new DefaultExchange(main.getOrCreateCamelContext()));
    }
}
